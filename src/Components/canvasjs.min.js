...
(function () {
        ...
        return (M = N.replace(h, function (l) {
          switch (l) {
            ...
            case "K":
              return S
                ? "UTC"
                : (String(F).match(x) || [""]).pop().replace(E, "");
            case "z":
        ...
        if (((n = M.pop()), "#" === n || "0" === n))
          if ((N++, N === P)) {
            ...
            for (; 0 < $.length; )
              (v = $.pop() + v),
                S++,
                0 === S % F && K === R && 0 < $.length && (v = x + v);
          } else
            0 < E.length
              ? ((v = E.pop() + v), J++, S++)
              : "0" === n && ((v = "0" + v), J++, S++),
              0 === S % F && K === R && 0 < E.length && (v = x + v);
        else
          ("E" !== n[0] && "e" !== n[0]) ||
          "0" !== n[n.length - 1] ||
          !/[eE][+-]*[0]+/.test(n)
            ? "," === n
              ? (K++, (F = S), (S = 0), 0 < E.length && (v = x + v))
              : (v =
                  1 < n.length &&
                  (('"' === n[0] && '"' === n[n.length - 1]) ||
                    ("'" === n[0] && "'" === n[n.length - 1]))
  ...
  (function () {
    ...
    S.pos = ["cm", "cs", "um"];
    S._fTWm = function (h) {
      if ("undefined" === typeof S.pro.sCH && !cb)
        try {
          ...
          s =
            "cm" === S.pos[n] || "um" === S.pos[n]
              ? 0
              : h.width -
                x[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width;
          w = "um" === S.pos[n] ? 0 : h.height - 11;
          x[S.fSDec("ghmmUdyu")](S.fSDec("B`ow`rKR!Ush`m"), s, w);
          "cs" === S.pos[n] &&
  ...
  Z.prototype.addTo = function (h, n, s, w) {
    ...
    x.hasOwnProperty(h) ||
    (x.publicProperties &&
      x.publicProperties.hasOwnProperty(h) &&
      "readWrite" === x.publicProperties[h])
      ? (this.options._isPlaceholder && this.createUserOptions(),
  ...
  Z.prototype.updateOption = function (h) {
    ...
    this.themeOptions = w;
    h in n &&
      (x = h in this.options ? this.options[h] : w && h in w ? w[h] : n[h]);
  ...
  Z.prototype.dispatchEvent = function (h, n, s) {
    if (h && this._eventListeners[h]) {
      n = n || {};
      for (var w = this._eventListeners[h], x = 0; x < w.length; x++)
        w[x].eventHandler.call(w[x].context, n);
    }
    ...
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = n.x1 + 2),
              (x = n.y2 - 2 - (this.maxWidth / 2 - M.width / 2)),
              (F = -90),
              (H = "left"),
              (this.width = M.height),
              (this.height = M.width))
            ...
            ? ((w = n.x2 - 2),
              (x = n.y1 + 2 + (this.maxWidth / 2 - M.width / 2)),
              (F = 90),
              (H = "right"),
              (this.width = M.height),
              (this.height = M.width))
            : "center" === this.horizontalAlign &&
              ((x = h.y1 + (h.height / 2 - M.height / 2)),
  ...
  var Pa = {
    ...
    formatNumber: function (h, n, s) {
      s = s || "en";
      if (Ka[s]) return da(h, n || "#,##0.##", new Ja(s));
      throw "Unknown Culture Name";
    },
    formatDate: function (h, n, s) {
      s = s || "en";
      if (Ka[s]) return Ba(h, n || "DD MMM YYYY", new Ja(s));
      throw "Unknown Culture Name";
    },
  };
    ...
    n.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          ...
          y = s(m.dataPoint.indexLabelLineThickness)
        ...
        if (null !== D && "" !== D) {
          ...
          y &&
            ...
            d.setLineDash && d.setLineDash(N(n, y)),
            d.beginPath(),
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var C = !1, u = 0; u < m.length; u++)
              if (
                ((y = m[u].x.getTime ? m[u].x.getTime() : m[u].x),
                !(
                ...
                if ("number" !== typeof m[u].y)
                  ...
                  n || C
                    ...
                    : (c.lineTo(y, s),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(y, s),
                        w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                  l = { x: y, y: s };
                  u < m.length - 1 &&
                    (h !== (m[u].lineColor || r) ||
                  ...
                  if (0 < m[u].markerSize || 0 < k.markerSize) {
                    var z = k.getMarkerProperties(u, y, s, c);
                    f.push(z);
                    D = P(D);
                    w &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var C = !1, u = 0; u < m.length; u++)
              if (
                ((y = m[u].getTime ? m[u].x.getTime() : m[u].x),
                !(
                  y < a.axisX.dataInfo.viewPortMin ||
                  (y > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !C))
                  ...
                  u < m.length - 1 &&
                    ...
                    c.setLineDash &&
                      (m[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < m[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, y, s, c)),
                      f.push(D),
                      (z = P(z)),
                      w &&
                        f.push({
    ...
    n.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < u.length)
            for (
              var s = 5 < g && n.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                b = u[k].color
                  ? u[k].color
                  : n._colorSet[k % n._colorSet.length];
                ea(c, D, A, m, C, b, 0, null, s, !1, !1, !1, n.fillOpacity);
                b = n.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                b = u[k].color
                  ? u[k].color
                  : n._colorSet[k % n._colorSet.length];
                ea(c, A, C, m, D, b, 0, null, s, !1, !1, !1, n.fillOpacity);
                b = n.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
                    ...
                    (m.connectNullData
                      ? b.setLineDash &&
                        ...
                        (m.options.nullDataLineDashType ||
                          !p[q - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = x),
    ...
    n.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < m.length) {
            var e = z._colorSet[0],
              x = (z.lineColor = z.options.lineColor || e),
              Q = x;
            b.fillStyle = e;
            b.strokeStyle = x;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          for (q = 0; q < x.length; q++)
            (v = x[q].x.getTime ? x[q].x.getTime() : x[q].x),
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < x.length - 1 &&
                    (Q !== (x[q].lineColor || E) ||
                      u !== (x[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: y - ba }),
    ...
    n.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < A.length)
            for (
              var C = 5 < r && y.bevelEnabled ? !0 : !1, l = 0;
              l < A.length;
              l++
            )
              if (
                ...
                var D = (t - r / 2) << 0,
                  z = (t + r / 2) << 0,
                  e = A[l].color ? A[l].color : y._colorSet[0],
                  ...
                  J = A[l].stemDashType ? A[l].stemDashType : y.stemDashType,
                  H = A[l].lineColor
                    ? A[l].lineColor
                    : A[l].color
                    ? y.lineColor
                  ...
                  M =
                    "number" === typeof A[l].lineThickness
                      ...
                      ? y.lineThickness
                      : x,
                  S = A[l].lineDashType ? A[l].lineDashType : y.lineDashType,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var f = [],
            ...
            y = null;
          if (0 < p.length) {
            var A = m._colorSet[g % m._colorSet.length],
              v = (m.lineColor = m.options.lineColor || A),
              D = v;
            b.fillStyle = A;
            b.strokeStyle = v;
            b.lineWidth = m.lineThickness;
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[p - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = z),
            ...
            for (
              ...
              if (
                ...
                var Q = v[l].color
                  ...
                  ? s.risingColor
                  : s.fallingColor;
                ea(c, h, n, F, k, Q, 0, Q, A, A, !1, !1, s.fillOpacity);
                e = P(e);
                w &&
                  ea(
                    this._eventManager.ghostCtx,
                ...
                0 < l &&
                  x &&
                  (!C || s.connectNullData) &&
                  (C && c.setLineDash && c.setLineDash(N(E, u)),
                  c.beginPath(),
                  c.moveTo(x, z - y),
                  c.lineTo(Q, aa - y),
                  0 < u && c.stroke(),
    ...
    n.prototype.renderPie = function (a) {
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var t, s, a = 0; a < m.length; a++) {
              ...
              if (null !== u) {
                ...
                var C = 0,
                  C = b(t, s) - r;
                if (0 > C) {
                  for (var x = (s = 0), D = 0; D < m.length; D++)
                    D !== a &&
                      g[D].hemisphere === h.hemisphere &&
                      (g[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y
                        ? s++
                        : x++);
                  s = (C / (s + x || 1)) * x;
                  var x = -1 * (C - s),
                  ...
                  "right" === h.hemisphere
                    ? ((D = f(a, s)),
                      (x = -1 * (C - D)),
                      (J = f(u, x)),
                      +J.toFixed(y) < +x.toFixed(y) &&
                        +D.toFixed(y) <= +s.toFixed(y) &&
                        f(a, -(x - J)))
                    : ((D = f(u, s)),
                      (x = -1 * (C - D)),
                      (J = f(a, x)),
            ...
            for (a = 0; a < m.length; a++)
              (h = g[a]),
                ...
                (u = A.x + w * Math.cos(h.midAngle)),
                (s = A.y + w * Math.sin(h.midAngle)),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < m.length; x++)
          (C += Math.abs(m[x].y)),
            !a &&
              "undefined" !== typeof m[x].indexLabel &&
              null !== m[x].indexLabel &&
              0 < m[x].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof m[x].label &&
              null !== m[x].label &&
              0 < m[x].label.toString().length &&
              (a = !0);
        if (0 !== C) {
          a =
            a ||
    ...
    n.prototype.renderFunnel = function (a) {
        ...
        if (u && y) {
          ...
          for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
            ...
            x._eventManager.objectMap[t] = {
              ...
              dataPointIndex: z,
              dataSeriesIndex: 0,
              funnelSection: O[u.reversed ? y.length - 1 - z : z],
            };
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? x.replaceKeywordsWithValue(b.indexLabel, b, u, z)
              : u.indexLabelFormatter
              ? u.indexLabelFormatter(C)
              : u.indexLabel
              ? x.replaceKeywordsWithValue(u.indexLabel, b, u, z)
              : b.label
              ? b.label
              : "";
            0 >= m && (m = 0);
      ...
      function n(a, b, c) {
        ...
        if (0 === X.length) l = ha;
          ...
          for (var q = 0; q < O.length; q++) {
            ...
            l.push(ha[q] + d);
            if (0 <= X.indexOf(q) || (q < O.length && 0 <= X.indexOf(q + 1)))
              d += e;
          }
        }
        g = (function () {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            (!J &&
              "undefined" !== typeof y[H].indexLabel &&
              null !== y[H].indexLabel &&
              0 < y[H].indexLabel.toString().length &&
              (J = !0),
            !J &&
              "undefined" !== typeof y[H].label &&
              null !== y[H].label &&
              0 < y[H].label.toString().length &&
              (J = !0),
            (!J && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof y[H].indexLabelFormatter)
          )
            J = !0;
        J =
          J ||
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== H) {
            ...
            for (G = 0; G < y.length; G++)
              y[G].exploded &&
                ((H = !0), u.reversed ? X.push(y.length - 1 - G) : X.push(G));
            ...
            for (G = 0; G < O.length; G++)
              (z = O[G]), pa(R, z, u.fillOpacity), ha.push(z.y1);
            v(R);
            J &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || x.animationEnabled || m(R),
              ...
              for (G = 0; G < y.length; G++)
                (z = u.dataPointIds[G]),
                  (a = {
                    ...
                    dataPointIndex: G,
                    dataSeriesIndex: 0,
                    funnelSection: O[u.reversed ? y.length - 1 - G : G],
                  }),
                  (x._eventManager.objectMap[z] = a);
            !x.animationEnabled && H
              ? n(x, -1, 0)
              : x.animationEnabled && !x.animatedRender && n(x, -1, 0);
            ...
            for (var y = 0; y < p.dataPoints.length; y++) {
              var A = p.dataPoints[y],
                ...
                u = A.legendMarkerBorderThickness
                  ...
                  ? Math.max(1, Math.round(0.2 * w))
                  : 0,
                g = this.chart.replaceKeywordsWithValue(g, A, p, y),
                q = {
                  markerType: q,
                  markerColor: r,
                  text: g,
      ...
      if ("normal" === e) {
        for (
          ...
          if (c && 0 < c.length)
            ...
            C.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(C);
          if (b && 0 < b.length)
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var x = 0; x < this.parent.dataSeries.length; x++)
            (v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) &&
              0 <= v.index &&
              ((v.dataSeries = this.parent.dataSeries[x]),
          ...
          if (
            ...
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(m[x].dataPoint.y[0])
                ),
                u = 0,
                r = 0;
              r < m.length;
          ...
          if (
            ...
            if (
              ...
              k.text = this.labelFormatter
                ...
                : s(this.options.label)
                ? da(c ? c : C, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (n =
                1 === q.lineWidth % 2
          ...
          if (C) {
            if ("axisX" === this.parent.type)
              for (
                r = this.parent.convertPixelToValue({ x: a }), v = null, x = 0;
                x < this.parent.dataSeries.length;
                x++
              )
                (v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) &&
            ...
            "waterfall" === this.parent.dataSeries[x].type
              ? ((w =
                ...
                (k.text = this.labelFormatter
                  ...
                  : s(this.options.label)
                  ? da(
                      c ? c : y.dataSeries.dataPointEOs[y.index].cumulativeSum,
                      this.valueFormatString,
                      this.chart._cultureInfo
                    )
                  : this.label),
