...
const Home = () => {
  ...
  const handleSubmission = (e) => {
    ...
    fetch(baseUrl + "emotion-detection", requestOptions)
  ...
  const handleEmotionSubmit = () => {
    ...
    fetch(baseUrl + "retrain", requestOptions)
      .then((response) => response.text())
      .then((result) => {
        setSubmitLoad(false);
        alert("Response Submited Sucessfully")
      })
      .catch((error) => {
        setSubmitLoad(false)
        alert("Failed to Re-Train")
      });
  };
  return (
    <>
      ...
      >
        <Toolbar>
          ...
          <Stack direction="row" spacing={2}>
            <Typography
              variant="h6"
              style={{ color: "white", margin: "1px 0" }}
            >
              {username}
            </Typography>
            ...
            {isSelected ? (
              ...
              >
                ...
                <Button
                  ...
                  style={{ margin: "20px 37%", backgroundColor: "black" }}
                >
                  Remove File
                </Button>
                {load === false ? (
      ...
      {showOutput === true ? (
        <Box style={{ backgroundColor: "rgb(192 123 170)", padding: "30px" }}>
          ...
          >
            ...
            >
              What was your intended Speech Emotion
            </Typography>
          </Grid>
          <Grid
            item
          ...
          >
            ...
            >
              ...
              <MenuItem value={"Suprise"}>Surprise</MenuItem>
            </Select>
          </Grid>
          <Grid
            item
